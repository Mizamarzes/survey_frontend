...
// Guardar una encuesta y retornar el ID de la encuesta creada
export async function saveSurvey(survey) {
  try {
    const token = getToken();

    // Hacer la petición POST para crear la encuesta
    ...
    const surveyId = createdSurvey.id; // Obtener el ID desde la respuesta

    return surveyId; // Retornar el ID
